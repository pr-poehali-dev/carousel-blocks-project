    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="grid gap-6 mb-12">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Предоставить доступ к качественному и эксклюзивному контенту
                  для наших пользователей. Мы стремимся создать удобную и
                  безопасную платформу с лучшими материалами.
                </p>
              </div>
            </div>
          </Card>
          ...
          <Card
            className="p-6 hover:shadow-xl hover:shadow-secondary/10 transition-all duration-300 animate-fade-in"
          ...
          <Card
            className="p-6 hover:shadow-xl hover:shadow-accent/10 transition-all duration-300 animate-fade-in"
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Мы гарантируем конфиденциальность ваших данных и безопасность
                  платежей. Вся информация надежно защищена современными
